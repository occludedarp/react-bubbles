...
- [ ] Explain what a token is used for.
  a token is an encrypted piece of data that allow or prohibit the storing and retrieval of authorized information 
- [ ] What steps can you take in your web apps to keep your data secure?
  req
  preventing unathorized users from accessing any aspects of the appliaction associated with authorized users and requiring the correct token before rendering user specific information
- [ ] Describe how web servers work.

  web servers are machines with the software describing how the server should respond to different requests for information. the software either contains or interacts with a database in order to respond to the request with the appropriate information. These applications are "hosted" on the servers space.
